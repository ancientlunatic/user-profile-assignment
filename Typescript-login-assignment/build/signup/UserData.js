...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Common Method/HttpRequest", "../Models/Usermodel"], factory);
    }
    ...
    var SignUp = /** @class */ (function () {
        ...
        SignUp.GetData = function () {
            ...
            user.ProfileImage = document.getElementById("profile").files[0];
            user.PhoneNumber = document.getElementById("phone").value;
            user.UserName = document.getElementById("Username").value;
            user.password = document.getElementById("password").value;
            return user;
        };
        SignUp.Getfields = function () {
        ...
        SignUp.upload = function () {
            return __awaiter(this, void 0, void 0, function () {
                var url, data, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            url = "https://localhost:44324/api/OAuth/signup";
                            data = this.Getfields();
